...
def vis_matches_all(img1, kp1, x_trans1, y_trans1, img2, kp2, x_trans2, y_trans2, matches):
    # patch-image
    # out_img = draw_Matches(img1, kp1, x_trans1, y_trans1, img2, kp2, matches)
    # patch-patch
    out_img = draw_Matches_trans(img1, kp1, x_trans1, y_trans1, img2, kp2, x_trans2, y_trans2, matches)
    return out_img